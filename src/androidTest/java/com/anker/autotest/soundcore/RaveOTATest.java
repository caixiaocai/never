    ...
    public void otaTest() throws Exception {
        ...
        while (true) {
            ...
            try {
                ...
                Thread.sleep(5000);
                mDevice.wait(Until.findObject(By.res("com.oceanwing.soundcore:id/st_positive").text("More")), 10000);
                ...
                } else if (mDevice.findObject(new UiSelector().resourceId("com.oceanwing.soundcore:id/linear_right3")).exists()) {
                    mDevice.findObject(new UiSelector().resourceId("com.oceanwing.soundcore:id/linear_right3")).clickAndWaitForNewWindow();
                    mDevice.findObject(new UiSelector().resourceId("com.oceanwing.soundcore:id/more_fw_check_btn").text("UPDATE")).clickAndWaitForNewWindow();
                }
...
//                            mDevice.findObject(new UiSelector().resourceId("com.oceanwing.soundcore:id/frame_install_complete")).clickAndWaitForNewWindow();
