...
public class M2FirewareOTATest {
    ...
    public void test() throws Exception {
        ...
        while (true) {
            ...
            obj = mDevice.wait(Until.findObject(By.text("Projector settings")), 5000);
            obj.click();

            obj = mDevice.wait(Until.findObject(By.res("com.microcast.tv.settings:id/list")), 3000);
            obj.fling(Direction.DOWN);
            obj = mDevice.wait(Until.findObject(By.text("Updated version")), 5000);
            obj.click();
            obj = mDevice.wait(Until.findObject(By.res("com.microcast.tv.settings:id/on_button_result_btn").text("Download Now")), 10000);
            if (obj == null) {
                ...
                obj.click();
                obj = mDevice.wait(Until.findObject(By.res("com.microcast.tv.settings:id/upgrade_btn").text("Upgrade")), 10000);
                if (obj == null) {
